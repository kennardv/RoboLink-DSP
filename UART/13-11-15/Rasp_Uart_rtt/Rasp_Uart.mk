# File name: Rasp_Uart.mk
# Autogenerated on: 18-Nov-2015 15:12:41
...
COMPILER_CODEGEN_ARGS := -I"/Volumes/Macintosh HDD/Documenten HDD/School/Elektronische systemen/13-11-15/Rasp_Uart_rtt" -I"/Volumes/Macintosh HDD/Documenten HDD/School/Elektronische systemen/13-11-15" -I"/Applications/MATLAB_R2015a.app/extern/include" -I"/Applications/MATLAB_R2015a.app/simulink/include" -I"/Applications/MATLAB_R2015a.app/rtw/c/src" -I"/Applications/MATLAB_R2015a.app/rtw/c/src/ext_mode/common" -I"/Applications/MATLAB_R2015a.app/rtw/c/ert" -I"/Applications/MATLAB_R2015a.app/toolbox/coder/rtiostream/src/utils" -I"/Applications/MATLAB_R2015a.app/toolbox/shared/dspblks/extern/include" -I"/Applications/MATLAB_R2015a.app/rtw/c/src/rtiostream/rtiostreamtcpip" -O3 -D"MODEL=Rasp_Uart" -D"NUMST=1" -D"NCSTATES=0" -D"HAVESTDIO=" -D"UNIX=" -D"ON_TARGET_WAIT_FOR_START=1" -D"ONESTEPFCN=0" -D"EXT_MODE=1" -D"TERMFCN=1" -D"MAT_FILE=0" -D"MULTI_INSTANCE_CODE=0" -D"INTEGER_CODE=0" -D"MT=0" -D"CLASSIC_INTERFACE=0" -D"ALLOCATIONFCN=0" -D"TID01EQ=0" -D"_USE_TARGET_UDP_=" -D"_RUNONTARGETHARDWARE_BUILD_=" -D"EXIT_FAILURE=1" -D"EXTMODE_DISABLETESTING="
COMPILER_TCCFG_ARGS   := -c
COMPILER_ARGS         := $(COMPILER_CODEGEN_ARGS) $(COMPILER_TCCFG_ARGS)
LINKER_CODEGEN_ARGS   :=  -lm -ldl -lpthread -lrt 
LINKER_TCCFG_ARGS     := -o $(TARGET) -|wiringPi
