...
def set_row1(data, data12A1):
    ...
    if data == 1:
        data12A1 = (~1 & data12A1 & 0xFF)
        print bin(data12A1)
    #bus.write_byte_data(addressU1,0x12,data)
    elif data == 2 :
        data12A1 = (~3 & data12A1 & 0xFF)
        print bin(data12A1)
    #bus.write_byte_data(addressU1,0x12,data)
    elif data == 3 :
        data12A1 = (~7 & data12A1 & 0xFF)
        print bin(data12A1)
    #bus.write_byte_data(addressU1,0x12,data)
    elif data == 4 :
        data12A1 = (~15 & data12A1 & 0xFF)
        print bin(data12A1)
    #bus.write_byte_data(addressU1,0x12,data)
    elif data >= 5 :
...
def set_row2(data, data12A1, data13A1):
    ...
    if data == 1:
        data12A1 = (~32 & data12A1 & 0xFF)
        print bin(data12A1)
    #bus.write_byte_data(addressU1,0x12,data)
    elif data == 2 :
        data12A1 = (~96 & data12A1 & 0xFF)
        print bin(data12A1)
    #bus.write_byte_data(addressU1,0x12,data)
    elif data == 3 :
...
def set_row3(data, data13A1):
    ...
    if data == 1:
        data13A1 = (~4 & data13A1 & 0xFF)
        print bin(data13A1)
    #bus.write_byte_data(addressU1,0x13,data)
    elif data == 2 :
        data13A1 = (~12 & data13A1 & 0xFF)
        print bin(data13A1)
    #bus.write_byte_data(addressU1,0x13,data)
    elif data == 3 :
        data13A1 = (~28 & data13A1 & 0xFF)
        print bin(data13A1)
    #bus.write_byte_data(addressU1,0x13,data)
    elif data == 4 :
        data13A1 = (~60 & data13A1 & 0xFF)
        print bin(data13A1)
    #bus.write_byte_data(addressU1,0x13,data)
    elif data >= 5 :
        data13A1 = (~124 & data13A1 & 0xFF)
        print bin(data13A1)
#bus.write_byte_data(addressU1,0x13,data)
    return (data13A1)
...
def set_row4(data, data12A2):
    ...
    if data == 1:
        data12A2 = (~1 & data12A2 & 0xFF)
    #bus.write_byte_data(addressU2,0x12,data)
    elif data == 2 :
        data12A2 = (~3 & data12A2 & 0xFF)
    #bus.write_byte_data(addressU2,0x12,data)
    elif data == 3 :
        data12A2 = (~7 & data12A2 & 0xFF)
    #bus.write_byte_data(addressU2,0x12,data)
    elif data == 4 :
        data12A2 = (~15 & data12A2 & 0xFF)
    #bus.write_byte_data(addressU2,0x12,data)
    elif data >= 5 :
...
def set_row5(data, data12A2, data13A2):
    ...
    if data == 1:
        data12A2 = (~32 & data12A2 & 0xFF)
    #bus.write_byte_data(addressU2,0x12,data)
    elif data == 2 :
        data12A2 = (~96 & data12A2 & 0xFF)
    #bus.write_byte_data(addressU2,0x12,data)
    elif data == 3 :
        data12A2 = (~224 & data12A2 & 0xFF)
    #bus.write_byte_data(addressU2,0x12,data)
    elif data == 4 :
        data13A2 = (~1 & data13A2 & 0xFF)
        #bus.write_byte_data(addressU2,0x13,data)
        data12A2 = (~224 & data12A2 & 0xFF)
        #bus.write_byte_data(addressU2,0x12,data)
    elif data >= 5 :
...
def set_row6(data, data13A2):
    ...
    if data == 1:
        data13A2 = (~4 & data13A2 & 0xFF)
    #bus.write_byte_data(addressU2,0x13,data)
    elif data == 2 :
        data13A2 = (~12 & data13A2 & 0xFF)
    #bus.write_byte_data(addressU2,0x13,data)
    elif data == 3 :
        data13A2 = (~28 & data13A2 & 0xFF)
    #bus.write_byte_data(addressU2,0x13,data)
    elif data == 4 :
        data13A2 = (~60 & data13A2 & 0xFF)
    #bus.write_byte_data(addressU2,0x13,data)
    elif data >= 5 :
        data13A2 = (~124 & data13A2 & 0xFF)
#bus.write_byte_data(addressU2,0x13,data)
    return (data13A2)
